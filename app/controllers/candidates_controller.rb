class CandidatesController < ApplicationController
  ...
  def publish
    ...
    redirect_to show_profile_path, notice: "Congratulations. Your profile was successfully published to potential employers.<br>In the meantime, <a href='#{new_invite_path}'>recommend your friends and receive #{Candidate::BOUNTY} for every friend that gets hired!</a>"
  end
